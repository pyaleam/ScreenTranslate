...
class Florence2Decoder(Florence2LanguagePreTrainedModel):
    ...
    def forward(
        ...
        past_key_values_length = (past_key_values[0][0].shape[2] if past_key_values[0] is not None and past_key_values[0][0] is not None else 0) if past_key_values is not None else 0
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        if past_key_values is not None:
            past_length = (past_key_values[0][0].shape[2] if past_key_values[0] is not None and past_key_values[0][0] is not None else 0)
